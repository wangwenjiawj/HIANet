...
if DATASET == 'WIKI':
    DATA_DIR = '/media/qd/copy/wangwenjia/master/CorrPM-master/LIP/images_labels/train_images'
    LABEL_DIR = '/media/qd/copy/wangwenjia/master/CorrPM-master/LIP/images_labels/train_segmentations'
    TRAIN_LABEL = '/media/qd/copy/wangwenjia/master/CorrPM-master/LIP/images_labels/train_id.txt'
    TEST_LABEL = '/media/qd/copy/wangwenjia/master/CorrPM-master/LIP/images_labels/val_id.txt'
